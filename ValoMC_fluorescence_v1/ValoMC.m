...
%     rnseed   Random number generator seed
    ...
    if(dimensionality == 2)
        ...
        if(isfield(vmcoptions,'export_filename'))        
            ...
            [solution.element_fluence, solution.boundary_exitance, solution.boundary_fluence, solution.F_element_fluence, solution.F_boundary_exitance, solution.F_boundary_fluence, solution.simulation_time, solution.seed_used] = MC3Dmex(H, HN, BH, r, BCType, BCIntensity, BCLightDirectionType, BCLightDirection, BCn, mua_ex_sol, mua_ex_f, mua_em_sol, mus_ex, mus_em, g, n, f, phase0, Nphoton, Qyield_f, Tau_f, disable_pbar, uint64(rnseed));
        end
