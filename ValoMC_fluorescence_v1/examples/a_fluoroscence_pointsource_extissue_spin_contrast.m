...
bin_size_xy=1.5;
bin_size_z=1.0;
h_disc=bin_size_xy/bins;
h_disc_1=bin_size_z/bins;
x_arr = h_disc/2:h_disc:bin_size_xy-h_disc/2;
y_arr = h_disc/2:h_disc:bin_size_xy-h_disc/2;
z_arr = h_disc_1/2:h_disc_1:bin_size_z-h_disc_1/2;
...
vmcmedium.scattering_coefficient_ex = mus_n;
vmcmedium.scattering_coefficient_em = mus_n*mus_mult;
vmcmedium.absorption_coefficient_ex_sol = mua_n;
%vmcmedium.absorption_coefficient_ex_f = muaf; 
vmcmedium.absorption_coefficient_ex_f =0.0;
%vmcmedium.absorption_coefficient_em_sol = mua_mult*mua+muaf*muaf_mult;
vmcmedium.absorption_coefficient_em_sol = mua_mult*mua_n; 

vmcmedium.scattering_anisotropy = 0.972;        
vmcmedium.refractive_index = 1.387;
...
radius_s=0.1;
center_s=[0.5 ((bin_size_xy/2)+10^(-5)) 0.3];
sphere=findsphere(vmcmesh,center_s,radius_s);
vmcmedium.scattering_coefficient_ex(sphere) = mus_c;
vmcmedium.scattering_coefficient_em(sphere) = mus_c*mus_mult;
vmcmedium.absorption_coefficient_ex_sol(sphere) = mua_c;
vmcmedium.absorption_coefficient_ex_f(sphere)=muaf;
vmcmedium.absorption_coefficient_em_sol(sphere)=mua_mult*mua_c+muaf*muaf_mult;
vmcmedium.refractive_index(sphere) = 1.901;
vmcmedium.scattering_anisotropy(sphere) = 0.958;
%% creating point source;
Point_LS=[((bin_size_xy/2)+10^(-5)) ((bin_size_xy/2)+10^(-5)) 0.0];
x_coord=vmcmesh.r(:,1);
y_coord=vmcmesh.r(:,2);
z_coord=vmcmesh.r(:,3);
temp=vmcmesh.BH;
